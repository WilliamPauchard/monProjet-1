 ...
 * @version 1.0
 */
import metier.EmployeDao;
public class FrmMain extends java.awt.Frame {
    
  public static ArrayList alstEmployes; 
  ...
  public FrmMain () {
    ...
    chargerEmployes();
     ...
     private void chargerEmployes () {
        alstEmployes = EmployeDao.getlisteEmployes();
        for (int k = 0; k < alstEmployes.size(); k++) {
            Employe e = (Employe)alstEmployes.get(k);
